...
const repeatMyParam = () => {
    axios.get('http://localhost:3000/repeat/thisIsVeryHard')
    .then(function(res){
...
function query(){
    axios.get('http://localhost:3000/query-test?monkey=chimpanzee&truck=ranger')
    .then(function(res){
...
/*
    ...
    -It sent a message saying multiple queries were sent. Then listed them 
*/
...
// CODE HERE 
function createFood(){
    foodInput = document.getElementById(food).value
